...
import 'package:miniflutter/Home/Components/Quicks/quickvideo2.dart';
import 'package:share_plus/share_plus.dart';
import 'package:sizer/sizer.dart';

class Quick2 extends StatefulWidget {
  const Quick2({super.key});

  @override
  State<Quick2> createState() => _Quick2State();
}

class _Quick2State extends State<Quick2> {
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                              "Hindu groups attacked foreign muslim groups",
                              style: TextStyle(
                                  fontFamily: "Astonpoliz",
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
