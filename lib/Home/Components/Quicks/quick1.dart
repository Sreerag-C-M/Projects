...
import 'package:miniflutter/Home/Components/Quicks/quickvideo1.dart';
import 'package:share_plus/share_plus.dart';
import 'package:sizer/sizer.dart';

class Quick1 extends StatefulWidget {
  const Quick1({super.key});

  @override
  State<Quick1> createState() => _Quick2State();
}

class _Quick2State extends State<Quick1> {
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                              "A car caught fire while travelling in Calicut Kerala",
                              style: TextStyle(
                                  fontFamily: "Astonpoliz",
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
